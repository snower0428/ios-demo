...
- (void)drawRect:(CGRect)rect
{
	...
	[blackBirdBackgroundPath addCurveToPoint: CGPointMake(_scalingFactor*135, _scalingFactor*203)
                               controlPoint1: CGPointMake(_scalingFactor*201.5, _scalingFactor*133.5)
                               controlPoint2: CGPointMake(_scalingFactor*164.21, _scalingFactor*157.79)];
    
	[blackBirdBackgroundPath addCurveToPoint: CGPointMake(_scalingFactor*112, _scalingFactor*253)
                               controlPoint1: CGPointMake(_scalingFactor*127.7, _scalingFactor*214.3)
                               controlPoint2: CGPointMake(_scalingFactor*112.61, _scalingFactor*250.71)];
    
	[blackBirdBackgroundPath addCurveToPoint: CGPointMake(_scalingFactor*97, _scalingFactor*221)
                               controlPoint1: CGPointMake(_scalingFactor*111.39, _scalingFactor*255.3)
                               controlPoint2: CGPointMake(_scalingFactor*97.02, _scalingFactor*221.14)];
    
	[blackBirdBackgroundPath addCurveToPoint: CGPointMake(_scalingFactor*75.5, _scalingFactor*239)
                               controlPoint1: CGPointMake(_scalingFactor*96.73, _scalingFactor*218.66)
                               controlPoint2: CGPointMake(_scalingFactor*75.97, _scalingFactor*237.71)];
    
	[blackBirdBackgroundPath addCurveToPoint: CGPointMake(_scalingFactor*108, _scalingFactor*267.5)
                               controlPoint1: CGPointMake(_scalingFactor*75.03, _scalingFactor*240.29)
                               controlPoint2: CGPointMake(_scalingFactor*99.74, _scalingFactor*262.89)];
