...
- (void) loadLauncherData {
    ...
    for (int i = 1; i < 15; i++) {
        ...
        [launcherItem setIdentifier:[NSString stringWithFormat:@"id_%d", i]];
        [launcherItem setTitleText:[NSString stringWithFormat:@"%d", i]];
        ...
        [launcherIcon setCanBeDeleted:YES];
        [self.launcherDataLeft addIcon:launcherIcon];
        [launcherItem release];
        [launcherIcon release];
    }
    ...
    for (int i = 1; i < 10; i++) {
        ...
        [launcherIcon setCanBeDragged:YES];
        [launcherIcon setCanBeDeleted:YES];
        [self.launcherDataRight addIcon:launcherIcon];
        [launcherItem release];
        [launcherIcon release];
    }
#endif
