...
{
    CGContextSaveGState(context);
    CGContextSetLineCap(context, kCGLineCapSquare); // 设置线帽，默认的是线条有一个“圆”末端，kCGLineCapSquare让线条有一个“正方形”末端
...
CGMutablePathRef createArcPathFromBottomOfRect(CGRect rect, CGFloat arcHeight)
{
    ...
    CGFloat arcRadius = (arcRect.size.height + pow(arcRect.size.width/2, 2) / arcRect.size.height)/2;
