...
//        [[UIImage imageNamed:@"Kal.bundle/vaccine_today_selected.png"] drawInRect:CGRectMake(0, 0, rect.size.width, rect.size.height)];
        textColor = [UIColor whiteColor];
        shadowColor = [UIColor blackColor];
        markerImage = [UIImage imageNamed:@"Kal.bundle/vaccine_btn_mark.png"];
    } else if ([self isToday] && !self.selected) {
//        [[UIImage imageNamed:@"Kal.bundle/vaccine_today.png"] drawInRect:CGRectMake(0, 0, rect.size.width, rect.size.height)];
        textColor = [UIColor whiteColor];
        shadowColor = [UIColor blackColor];
        markerImage = [UIImage imageNamed:@"Kal.bundle/vaccine_btn_mark.png"];
...
//        [[UIImage imageNamed:@"Kal.bundle/vaccine_today_selected.png"] drawInRect:CGRectMake(0, 0, rect.size.width, rect.size.height)];
    ...
    if (self.belongsToAdjacentMonth) {
        ...
        textColor = [UIColor colorWithRed:108.0/255.0 green:109.0/255.0 blue:112.0/255.0 alpha:1.0];
    }
#endif
...
//        [lunarText drawAtPoint:CGPointMake(textX, textY+textSize.height/2) withFont:font];
        ...
        [dayText drawInRect:topFrame withFont:[UIFont boldSystemFontOfSize:15] lineBreakMode:UILineBreakModeCharacterWrap alignment:UITextAlignmentCenter];
        
        if (specialDay) {
            textColor = [UIColor colorWithRed:206.0/255.0 green:27.0/255.0 blue:27.0/255.0 alpha:1.0];
        }
        else {
            textColor = [UIColor colorWithRed:102.0/255.0 green:97.0/255.0 blue:95.0/255.0 alpha:1.0];
        }
        
        [textColor setFill];
        [lunarText drawInRect:bottomFrame withFont:[UIFont systemFontOfSize:10] lineBreakMode:UILineBreakModeCharacterWrap alignment:UITextAlignmentCenter];
    }
    else {
