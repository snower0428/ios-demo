...
@implementation LHCoreGraphicsViewCtrl
...
- (void)loadView
{
    ...
    _arrayViewController = [[NSArray alloc] initWithObjects:
                            NSStringFromClass([LHCoreGraphicsDemoViewCtrl class]),
                            NSStringFromClass([RSInstagramArtworkVIewCtrl class]),
                            nil];
}
