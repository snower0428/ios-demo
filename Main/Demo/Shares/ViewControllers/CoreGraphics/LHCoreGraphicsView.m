...
@implementation LHCoreGraphicsView
...
//            CGFloat translate = (MIN(self.superview.bounds.size.width, self.superview.bounds.size.height) - sideLengthMax) / 2;
