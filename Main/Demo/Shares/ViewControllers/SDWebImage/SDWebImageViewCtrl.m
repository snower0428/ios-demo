...
@implementation SDWebImageViewCtrl
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell == nil)
    {
        ...
        UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(100, 0, SCREEN_WIDTH-100, 60)];
        label.tag = 102;
    ...
    if (imageView) {
        ...
        [imageView setImageWithURL:[NSURL URLWithString:[_objects objectAtIndex:indexPath.row]] placeholderImage:image];
    }
    
    UILabel *label = (UILabel *)[cell.contentView viewWithTag:102];
    if (label) {
        label.text = [NSString stringWithFormat:@"Image #%d", indexPath.row];
    }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    SDWebImageDetailViewCtrl *detailViewCtrl = [[SDWebImageDetailViewCtrl alloc] init];
    detailViewCtrl.imageURL = [NSURL URLWithString:largeImageURL];
