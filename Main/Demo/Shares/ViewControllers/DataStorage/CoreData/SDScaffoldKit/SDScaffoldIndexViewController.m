...
//    NSLog(@"[sectionInfo objects]:%@", [sectionInfo objects]);
...
- (void)configureCell:(UITableViewCell*)cell forRowAtIndexPath:(NSIndexPath*)indexPath{
    ...
    NSString *email = [managedObject valueForKey:@"email"];
    NSString *firstname = [managedObject valueForKey:@"firstname"];
    NSString *lastname = [managedObject valueForKey:@"lastname"];
    CGFloat price = [[managedObject valueForKey:@"price"] floatValue];
    
    NSLog(@"email:%@, firstname:%@, lastname:%@, price:%.02f", email, firstname, lastname, price);
