...
@interface LHControlsViewCtrl ()

@end

@implementation LHControlsViewCtrl
...
- (void)loadView
{
    ...
    _arrayViewController = [[NSArray alloc] initWithObjects:
                            NSStringFromClass([LHCALayerViewCtrl class]),
                            NSStringFromClass([SSCheckBoxViewCtrl class]),
                            nil];
}
