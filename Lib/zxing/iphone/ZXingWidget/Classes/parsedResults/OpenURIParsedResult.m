...
@implementation OpenURIParsedResult
...
- (ResultAction *)createAction {
  return [OpenAPPUrlAction actionWithURL:self.URL];
}
...
- (UIImage *)icon {
  return [[UIImageManager shareInstance] imageWithFileName:@"TwoDimension/link2.png"];
}
